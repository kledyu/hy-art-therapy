...
export default function SignUpProgress({ progress }: { progress: number }) {
  return (
    <div className='border-b border-bg-gray w-screen flex h-[60px] mb-[60px]'>
      <ul className='flex items-center  md:max-w-[1080px] w-full justify-center md:justify-end mx-auto text-sm md:title-m-18'>
