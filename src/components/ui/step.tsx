        ...
        {items.map((item, index) => {
          return (
            <li
              ...
              style={{ width }}
              className={cn(
                'border-r border-r-bg-gray-d first:border-l-1 first:border-l-bg-gray-d last:border-r-1 hover:bg-primary/10 hover:text-primary transition-all duration-300',
