  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'py-[12px] pl-[15px] pr-[8px]',
        'rounded-[4px]',
        'border border-[#E0E0E0]',
        'bg-white',
        'text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none',
        'disabled:cursor-not-allowed disabled:opacity-50',
        'focus-visible:ring-[3px] focus-visible:ring-primary/80 focus-visible:border-primary',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className='size-6 opacity-100' strokeWidth={1} />
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'overflow-x-hidden overflow-y-auto rounded-md border border-[#E0E0E0] shadow-md',
          position === 'popper' &&
