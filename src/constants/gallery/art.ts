  ...
  content: [
    {
      ...
      artName: '나를 향해 가는길',
      coDescription: null,
      caption: 'Acylic on canvas 100x80cm',
      files: {
    ...
    },
    {
      ...
      artName: '흔적',
      coDescription: null,
      caption: 'Acylic on canvas 73x91cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '무제',
      coDescription: null,
      caption: 'Gouache, Permanent Marker on canvas 50x70cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '내일의 희망을 꿈꾸며',
      coDescription: null,
      caption: 'Acylic on canvas 76.2x50.8cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '인사이드 미',
      coDescription: null,
      caption: 'Acylic on canvas 91.0x116.8cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: 'Amor fati',
      coDescription: null,
      caption: 'Acylic on canvas 91x65cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      coDescription: null,
      caption: 'Acylic on canvas 116.7x91cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '비추다',
      coDescription: null,
      caption: 'Acylic on canvas 117x80cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
      ...
      artists: [
        {
          artistName: '류민아',
          cohort: 24,
          description: `우리는 늘 바쁘고 빠른 세상 속에서 살아갑니다. 조금만 뒤처져도 불안해지고, 멈춰 서는 자신을 탓하게 됩니다. 하지만 때로는 느리게 걷는 것, 잠시 멈춰 숨을 고르는 것이야 말로 가장 필요한 시간이 되기도 합니다. 이번 전시는 미술치료사의 시선으로 바라본 '느림'의 가치에 대한 이야기입니다. 치유의 과정은 결코 빠르지 않습니다. 상처를 들여다보고, 감정을 표현하고, 다시 스스로를 다정하게 껴안기까지—그 모든 여정은 아주 천천히, 그러나 분명히 나아갑니다. 이 작품들은 느린 발걸음 속에서 피어난 감정과 회복의 흔적입니다. 완벽하지 않아도, 더디더라도 괜찮다는 진심을 담아, 스스로에게 허락하는 휴식과 위로의 시간을 함께 나누고자 합니다. "지금 이 속도로도 괜찮다"고 말해주는 이 공간에서, 당신의 마음도 잠시 숨을 고르길 바랍니다.`,
        },
      ],
    },
    {
      ...
      artName: '~기운',
      coDescription: null,
      caption: 'Acylic on canvas 91x73cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: 'Mobius',
      coDescription: null,
      caption: 'Acylic on canvas 72.7x91cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
      ...
      artists: [
        {
          artistName: '박리디아',
          cohort: 30,
          description: `우리는 넘어지면서 자연스럽게 상처를 입는다. 내 안을 자세히 볼 기회가 생긴 것이다. 들여다보면 그 속에서 다른 나를 발견할 수도 있다. 좋든 싫든 그것은 순전한 '나'다. 받아들이기로 한다.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      artName: 'To. JinHo',
      coDescription: null,
      caption: '조화 Acylic on canvas 72.7x90.9cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: 'amass',
      coDescription: null,
      caption: 'Acylic on canvas 65x91cm, 65x91cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '순환(cycle)',
      coDescription: null,
      caption: 'Acylic on canvas 50x50cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '타인의 아이',
      coDescription: null,
      caption: 'Acylic on canvas 91x116.8cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      artName: '비계(飛階)',
      coDescription: null,
      caption: 'Acylic on canvas 91.0x91.0cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
    ...
    },
    {
      ...
      coDescription: null,
      caption: '자연물 Acylic on canvas 91x117cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
      ...
      artists: [
        {
          artistName: '조혜미',
          cohort: 32,
          description: `때로는 흩어지고 때로는 엉켜버리는 감정과 생각들. 부드러운 선들이 흩어지지만 , 결국 다시 이어져 나 자신과 마주하는 순간 꽃을 피운다. 이 그림은 나 자신을 탐색하는 과정이다. 서로 다른 선들이 복잡한 감정과 생각을 품고 '나'라는 존재로 모여들고, 마침내 하나의 흐름을 이룬다.`,
        },
      ],
    },
    {
      ...
      artName: '일탈',
      coDescription: null,
      caption: 'Acylic on canvas 117x91cm',
      files: {
        url: 'https://placehold.co/1000x1000',
      },
      artists: [
        {
          artistName: '최지혜',
          cohort: 25,
          description: `최근 뜨개질을 처음 해보았습니다. 어릴 적부터 "꼼 꼼하지 않다."는 말을 듣고 자라, 과연 제대로 해낼 수 있을지 두려움이 앞섰지만 한 코씩 떠내려가 보니 점차 모양이 잡히기 시작했습니다. 그렇게 두려움은 사라지고 성취감이 차오르면서, 실수를 반복하는 과정 조차 신기할정도로 즐거웠습니 다. 그러던 중 문득 깨달았습니다. 그동안 '나와 맞지 않다'고스스로 한계를 정해 두었던 것임을. 중요한 것은 완성된 결과물이 아니라 시도하고 즐기는 마음임을 알게 된 순간,한계에서 벗어날 수 있었습니다`,
        },
      ],
    },
  ],
