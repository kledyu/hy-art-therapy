...
export const GALLERY_THERAPY_INTRO = {
  ...
  content: [
    "ART+THERAPY 展과 연계하여 진행되는 <b>MUSEUM THERAPY</b>는 관람객들이 미술 감상을 단순한 '보는 행위'를 넘어 <b>자기 돌봄과 회복의 시간</b>으로 확장할 수 있도록 하는 치유적 예술 프로그램입니다.",
    '작품 하나하나를 천천히 바라보고, 그 안에 머물며 떠오르는 감정과 생각을 스스로 들여다보는 이 경험은, 일상을 떠나 진정한 나를 찾는 치유의 시간을 제공합니다.',
